...
model_dir1 = 'fictionfrom' + str(modelfloor) + 'to' + str(modelceiling)
model_dir2 = 'fictionfrom' + str(modelfloor + 12) + 'to' + str(modelceiling + 12)
# model_dir3 = 'from' + str(modelfloor + 16) + 'to' + str(modelceiling + 16)
model_dir4 = 'fictionfrom' + str(modelfloor - 12) + 'to' + str(modelceiling - 12)
...
with open('fictionresults/CNsFrom' + str(floor) + 'To' + str(ceiling) + '.tsv', 'w') as file:
...
for year in range(floor, ceiling + 1):
    ...
    for paper in paperIds_in_year:
        ...
        with open('fictionresults/CNsFrom' + str(floor) + 'To' + str(ceiling) + '.tsv', 'a') as file:
